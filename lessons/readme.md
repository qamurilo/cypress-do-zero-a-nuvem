...
> I've used versions `22.5.1` and `10.8.2` of Node.js and npm, respectively. I suggest you use the same or later versions.
...
This project was created with 💚 by [Murilo](https://github.com/qamurilo).